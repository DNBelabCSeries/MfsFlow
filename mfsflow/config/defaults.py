...
DEFAULT_CONFIG = {
    ...
    "well_qc": {
        # A well is Active in the report only when all enabled thresholds pass.
        # These are report-level QC thresholds and do not change the matrix.
        "min_reads": 1000,
